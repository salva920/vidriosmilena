        ...
        <Container maxW="container.xl">
          ...
          {category && (
            <Box
              ...
              mb="8"
              bg={isCocinasLanding || isPergolasLanding || isTerrazasLanding ? 'transparent' : 'blue.900'}
            >
              ...
              {(
                isCocinasLanding
                  ...
                  : isPergolasLanding
                    ...
                    : isTerrazasLanding
                      ? 'https://dellorto.cl/wp-content/uploads/2025/03/CIERRES_DE_TERRAZA.jpg'
                      : category.image
              ) && (
                <Box
                  as="img"
                  ...
                  h="100%"
                  objectFit="cover"
                  opacity={isCocinasLanding || isPergolasLanding || isTerrazasLanding ? 1 : 0.3}
                />
              )}

              {/* Overlay con título sólo para categorías sin hero de imagen pura */}
              {!isCocinasLanding && !isPergolasLanding && !isTerrazasLanding && (
                <Box
                  position="absolute"
                  top="0"
                  left="0"
